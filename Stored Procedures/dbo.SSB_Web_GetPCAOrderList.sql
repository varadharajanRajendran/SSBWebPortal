...
INSERT INTO @tblOrderList (OrderID,EntryID,entryPK,EntrySts)
	...
	WHERE PT.id='HMB_OC_BUY'
		AND PS.id='In Progress'
	ORDER BY Pe.imposed_end_time ASC ,
		Pe.last_date ASC
	/*
	ORDER BY Po.[pom_order_id] ASC
	*/		
INSERT INTO @tblOrderList (OrderID,EntryID,entryPK,EntrySts)
	SELECT Po.[pom_order_id],
		   PE.[pom_entry_id],
