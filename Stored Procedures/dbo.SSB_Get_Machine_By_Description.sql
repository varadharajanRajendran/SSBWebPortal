...
DECLARE	@Machines AS Table	(	RowId			int	IDENTITY	,
 ...
 INSERT INTO @Machines(pk,MachineID)
	SELECT equip_pk,equip_label
...
SELECT MachineID	as [MachineDescription]	,
	   MachineModel as [MachineModel]		,		
	   MachineDesc	as [MachineGroup]		
	   /*,
	   Pk			as [pk]			*/
